// src/app/(Account)/login/LoginContent.tsx
'use client';
...
export default function LoginContent() {
  ...
  const { user, login, isLoading: authLoading, is_authenticated } = useAuth();
  ...
  }, [user, is_authenticated, authLoading, router, redirect]);
