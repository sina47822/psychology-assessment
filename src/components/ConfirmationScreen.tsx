    ...
    <div className="p-6 text-center">
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mb-8">
          ...
          <div className="bg-sky-50 border border-sky-200 rounded-xl p-6">
            <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center mb-4 mx-auto">
              <div className="text-2xl font-bold text-sky-600">{totalSelected}</div>
            </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center pt-6 border-t border-gray-200">
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
        >
